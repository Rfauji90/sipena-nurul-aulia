...
import { Search, User, Save, Edit, Trash, History, Eye, EyeOff } from 'lucide-react';
...
const HeadmasterNotes = () => {
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (passwordInput === 'catatanduaenam') {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          <h2 className="text-2xl font-bold text-center text-blue-700 mb-6">Akses Terbatas</h2>
          <p className="text-gray-600 text-center mb-6">Silakan masukkan kata sandi untuk mengakses halaman Catatan KS.</p>
            ...
            <div className="mb-4">
              <div className="relative">
                <input
                  ...
                  className={`w-full p-3 pr-10 border rounded focus:outline-none focus:ring-2 ${passwordError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}`}
                />
                <button
                  type="button"
              ...
              {passwordError && <p className="text-red-500 text-sm mt-1">Kata sandi salah.</p>}
            </div>
            <button
              type="submit"
